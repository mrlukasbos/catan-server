...
class Tile {
    ...
    public String typeToString(Type type) {
        switch (type) {
            ...
            case ORE: return "ore";
            case SEA: return "sea";
            case HARBOUR_WHOOL: return "harbour_whool";
            case HARBOUR_WOOD: return "harbour_wood";
            case HARBOUR_STONE: return "harbour_stone";
            case HARBOUR_GRAIN: return "harbour_grain";
            case HARBOUR_ORE: return "harbour_ore";
            case HARBOUR_ALL: return "harbour_all";
