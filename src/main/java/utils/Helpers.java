...
public class Helpers {
    ...
    public static <T> String toJSONArray(List<T> list, boolean escape) {
        if (list.size() == 0) {
            return  "[]";
        }
    ...
    public static <T> String getJSONArrayFromHashMap(HashMap<T, Integer> map, String keyName, String valueName) {
        String output = "[";
        if (map.size() == 0) {
            output = "[]";
        } else {
